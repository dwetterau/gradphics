...
#define CURVE_TYPE_BSPLINE_DC 2
#define CURVE_TYPE_BEZIER 3
#define CURVE_TYPE_BEZIER_DC 4
#define CURVE_TYPE_CATMULLROM 5
#define CURVE_TYPE_C2INTERPOLATING 6
#define CURVE_TYPE_COUNT 7
